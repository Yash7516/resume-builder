  ...
  return (
    <DashboardLayout>
      ...
      <Modal
        ...
        title={`Preview - ${resumeData.title}`}
        showActionBtn
        actionBtnText={
          isDownloading
            ? "Generating..."
      ...
      >
        <div className="relative">
          ...
          <div className="w-full overflow-auto flex justify-center px-4 pb-6">
            <div
              ref={resumeDownloadRef}
              className="bg-white shadow-md rounded-md"
              style={{
                width: "900px", // Increase this as needed, e.g. 1056px for A4 @96dpi
                maxWidth: "100%",
              }}
            >
              <RenderResume
                ...
                templateId={resumeData?.template?.theme || ""}
                resumeData={resumeData}
                containerWidth={900} // Match the width above
              />
            </div>
          </div>
        </div>
      ...
      {/* Hidden element for thumbnail generation */}
